...
public class GroceryActivity extends AppCompatActivity {
    ...
    private void setupData() {
        ...
        Grocery softDrinksAndJucie = new Grocery();
        softDrinksAndJucie.imageUrl ="https://resources.dunzo.com/web-assets/prod/_next/static/images/dunzo-daily-softdrinks-and-juice-09a3e724b1b1851ffe9747d4c03eb3b7.png";
        softDrinksAndJucie.title = "Soft Drinks & Jucie";
        groceries.add(softDrinksAndJucie);

        Grocery energySoftDrink = new Grocery();
        energySoftDrink.imageUrl ="https://resources.dunzo.com/web-assets/prod/_next/static/images/dunzo-daily-energy-and-sportsdrinks-8dc82b984a9a536206aa8685dce463b8.png";
        energySoftDrink.title = "Energy & Sports Drinks";
        groceries.add(energySoftDrink);
        ...
        groceries.add(masalaSpices);

        Grocery cannedFruits = new Grocery();
        cannedFruits.imageUrl ="https://resources.dunzo.com/web-assets/prod/_next/static/images/dunzo-daily-canned-fruit-and-vegetables-c6adef7534b8faa7100c671daab54e2f.png";
        cannedFruits.title = "Canned Fruits & Vegetables";
        groceries.add(cannedFruits);
